...
public class CustomSetV2Benchmark {
    ...
    @Benchmark
    public CustomSet<Integer> benchmarkConstructor() {
        return new CustomSet<>();
    }

    @Benchmark
    public CustomSet<Integer> benchmarkConstructorCollection() {
        return new CustomSet<>(inputCollection);
    }

    @Benchmark
    public CustomSet<Integer> benchmarkAdd() {
    ...
    @Benchmark
    public CustomSet<Integer> benchmarkClone() throws CloneNotSupportedException {
        return set.clone();
    }
    ...
    public boolean benchmarkEquals() {
        CustomSet<Integer> other = new CustomSet<>();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(CustomSetV2Benchmark.class.getSimpleName())
                .forks(1)
                .result("custom-set-v2-results.csv") // Output file path
    ...
    private static void writeCustomCsv(Collection<RunResult> results) {
        try (FileWriter writer = new FileWriter("CustomSetV2_jmh_performance.csv")) {
            ...
            System.out.println("JMH Performance report saved: CustomSetV2_jmh_performance.csv");
        } catch (IOException e) {
