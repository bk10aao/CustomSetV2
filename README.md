...
Larger values were tested for Version 1 and Version 2 but when testing HashSet with those it became very slow and have therefore been scaled down. These values and seperate charts comparing each can be found in the `PeformanceTesting` directory.
